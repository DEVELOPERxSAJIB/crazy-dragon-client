const categories = [
  {
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0gijivH1t0emtvA5nz6zjV3Si16R5P164Cg&s",
  },
  {
    name: "Beef Burgers",
  ...
  {
    name: "Wraps",
    image: "https://valentinascorner.com/wp-content/uploads/2023/06/Chicken-Wrap-Recipe-4.jpg",
  },
  {
    name: "Pasta",
    image: "https://www.recipetineats.com/tachyon/2025/08/Penne-alla-vodka_2.jpg",
  },
  {
    name: "Rice & Sides",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgdmlB1H9A8-ogZFv_6T1QvVfE6HhxByZ17g&s",
  },
  {
    name: "Chicken Wings",
  ...
  {
    name: "Fish",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRII35kUKRlMl0EW2TC7nhNZbhvjjLbnz5lA&s",
  },
  {
    name: "Kids Menu",
  ...
  {
    name: "Sauces",
    image: "https://www.acouplecooks.com/wp-content/uploads/2022/12/Tomato-Sauce-011.jpg",
  },
  {
    name: "Drinks",
    image: "https://images.immediate.co.uk/production/volatile/sites/30/2023/10/GF01115BackPagePSOCocktailspreview-829355e.jpg?quality=90&resize=708,643",
  },
];
...
const CardDesign = ({ category }) => {
  return (
    <a
      ...
      className="group relative block w-full aspect-square overflow-hidden rounded-lg shadow-md transition duration-300 hover:shadow-xl h-56"
    ...
    >
      ...
      <div className="z-50 absolute inset-0 flex items-center justify-center p-4">
