    ...
    <footer className="bg-[#491648] text-white">
      ...
      <div className="py-10">
        <div className="max-w-7xl mx-auto px-4 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Payment Icons */}
          <div>
            <h4 className="font-semibold mb-2 text-lg text-white">We Accept</h4>
          ...
          <div className="flex flex-col gap-1">
            <h4 className="font-semibold mb-2 text-lg text-white">Opening Hours</h4>
            <p className="text-white/80 text-[14px]">Everyday: 11:00 — 23:00</p>
          </div>

          {/* Contact */}
          <div className="flex flex-col gap-1">
            <h4 className="font-semibold mb-2 text-lg text-white">Contact</h4>
            <p className="text-white/80 text-[14px]">+31 6 1234 5678</p>
          </div>

          {/* Social Media */}
          <div className="flex flex-col gap-2">
            <h4 className="font-semibold mb-1 text-md text-white">Follow Us</h4>
